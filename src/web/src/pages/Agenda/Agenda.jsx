...
export default function Agenda() {
  ...
  const [hoveredCelula, setHoveredCelula] =
    useState(null);
          ...
          {HORAS.map(hora => (
            ...
            >
              ...
              {dias.map((d, i) => {
                ...
                const agend =
                  getAgendamento(d, hora);

                const isHovered =
                  hoveredCelula?.dia === i &&
                  hoveredCelula?.hora === hora;

                return (

                  <div
                    key={i}
                    className={`cal-celula ${
                      ehHoje(d)
                        ? 'celula-hoje'
                        : ''
                    }`}
                  ...
                  >
                    ...
                    {agend ? (
                      ...
                      <div className="agend-card">
                        ...
                        <p className="agend-nome">
                          {agend.paciente}
                        </p>

                        <p className="agend-prob">
                          {agend.problema}
                        </p>
